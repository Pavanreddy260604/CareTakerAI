...
export const BiologicalStatus: React.FC<Props> = ({ metrics }) => {
    ...
    return (
        <div className={`mb-5 border ${isLocked ? "border-destructive bg-destructive/5" : "border-primary/30 bg-card/40"} backdrop-blur-xl shadow-2xl p-4 sm:p-5 rounded-xl relative overflow-hidden transition-colors duration-500`}>
